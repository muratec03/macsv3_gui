 ...
 * 2019/03/08 MACS4#0114  GUI MCSAlarmクリア対応                      T.Iga/CSC
 ******************************************************************************
 */
$(function() {
  // 画面初期化時の処理
  ...
  function extract(cond) {
    dataTables.getDataAjax({
      url: getUrl('/Alarm/GetAlarmList'),
      cond: cond,
      searchDataFlag: true,
      //tableCompId: 'I-001-dataTables', // テーブルコンポーネントID
      tableCompId: 'I-001-alarms_dataTables', // テーブルコンポーネントID
