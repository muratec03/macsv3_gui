...
//	    var rect1 = $('<rect class="stat-01 status-box" x="16" y="20" width="20" height="6" />');
	    var rect1 = $('<rect class="stat-01 status-box" x="12" y="20" width="28" height="6" />');
	    var rect2 = $('<rect class="stat-02 status-box" x="12" y="28" width="28" height="6" />');
	    var rect3 = $('<rect class="stat-03 status-box" x="12" y="36" width="28" height="6" />');
//	    var text1 = $('<text class="stat-num" x="23" y="17">(1)TSCState</text>');
	    var text1 = $('<text class="stat-num" x="17" y="17">TSC State</text>');
	    var text2 = $('<text class="stat-num" x="13" y="24.5">Carrier</text>');
	    var text3 = $('<text class="stat-num" x="13" y="32.5">Occupied Rate</text>');
	    var text4 = $('<text class="stat-num" x="13" y="40.5">Port State</text>');
	    parentDiv.append(i);
	    i.append(svg);
...
//	    var text2 = $('<text class="stat-num" x="23" y="36.5">(4)</text>');
	    var rect1 = $('<rect class="stat-01 status-box" x="12" y="23" width="28" height="6" />');
	    var rect2 = $('<rect class="stat-02 status-box" x="12" y="32" width="28" height="6" />');
	    var text1 = $('<text class="stat-num" x="13" y="27.5">Carrier</text>');
	    var text2 = $('<text class="stat-num" x="13" y="36.5">Port State</text>');
//20200108 DQY MOD END	    
	    parentDiv.append(i);
	    i.append(svg);
	    svg.append(polygon, path, rect1, rect2, text1, text2);
