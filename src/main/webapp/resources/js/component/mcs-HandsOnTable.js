...
//        var memberGroup = $(elem.currentTarget).closest('div.container').find('input[name="memberGroup"]').val();// MACS4#MACSV2 Add
        var llcId = $(elem.currentTarget).closest('div.container').find('input[name="llcId"]').val();    // MACS4#MACSV3 Add
...
//    	var displayId = $(elem.currentTarget).closest('div.container-cdc').find('input[name="displayId"]').val();    // 20200218 DQY Del
...
//    	var memberGroup = $(elem.currentTarget).closest('div.container-cdc').find('input[name="memberGroup"]').val();
    	var llcId = $(elem.currentTarget).closest('div.container-cdc').find('input[name="llcId"]').val();    // MACS4#MACSV3 Add
    	var llcName = $(elem.currentTarget).closest('div.container-cdc').find('input[name="llcName"]').val();// MACS4#MACSV3 Add  
