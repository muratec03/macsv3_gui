		...
		draw: function() {
			...
			if (opts.display) {
				...
				var drawLegendBox = function(x, y, legendItem) {
					...
					} else if (opts.labels && me.chart.data.datasets[legendItem.datasetIndex].type == 'line') {
					  var radius = fontSize * Math.SQRT2 / 2;
					  var offSet = radius / Math.SQRT2;
					  var centerY = y + offSet;
					  ctx.fillRect(x, centerY, boxWidth, me.chart.data.datasets[legendItem.datasetIndex].borderWidth);
					} else {
