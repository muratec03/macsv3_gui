...
<script>
  ...
  McsTransferLocationSelectBox.language = {
    transferLocationCommon: {
      labels: {
        location: '<spring:message code="TransferLocationSelectBox_Common.language.labels.location"/>',
    ...
    transferLocationSelect: {
      labels: {
        ...
        machine: '<spring:message code="TransferLocationSelectBox_Select.language.labels.machine"/>',
        port: '<spring:message code="TransferLocationSelectBox_Select.language.labels.port"/>'
      },
      selects: {
