...
<script>
 ...
 --%>
<%-- 画面固有ヘッダ --%>
<title><spring:message code="II-002-01-001" /></title>
<link rel="stylesheet" href="<c:url value="/resources/css/top/mcs-Ports.css?Ver=${version}" />">
<script src="<c:url value='/resources/js/top/mcs-Ports.js?Ver=${version}'/>"></script>
...
<body>
    ...
    <header id="mcs-header-menu">
        <h1>
            <spring:message code="II-002-01-001" />
        </h1>
...
<!-- DEL END APL 2020.02.23 song 天津村研  MCSV4　GUI開発  Ver3.0 Rev.000  -->
    ...
    <div id="list-screen" class="mcs-content mcs-with-subtitle">
        <div id="mcs-subtitle-list" class="mcs-content-subtitle">
            <spring:message code="II-002-01-002" />
        </div>
