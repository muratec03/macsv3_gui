...
<script>
  var screenText = {
    ...
    menuText: {
      ...
      transferJob: '<spring:message code="IT-001-02-003" />',
      stageInfo: '<spring:message code="IT-001-02-009" />',      // MACS4#0049 Add
      history: '<spring:message code="IT-001-02-004" />',
      log: '<spring:message code="IT-001-02-005" />',
      statis: '<spring:message code="IT-001-02-006" />',
      maint: '<spring:message code="IT-001-02-007" />',
      cancel: '<spring:message code="IT-001-02-008" />'
    },
    slideHistoryText: {
...
<%--            <h2 class="mcs-info-schm-ttl">                                   MACS4#0158 Del --%>
    ...
    <nav id="mcs-right-menu">
        ...
        <!-- 搬送ジョブ情報表示 -->
        <div id="menu-btn-transferJob" class="btn-mcs-slide" data-auth="${I003_REF}"></div>
