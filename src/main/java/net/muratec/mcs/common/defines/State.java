 ...
 *
 * Revision 1.2  2009/02/14 06:56:54  okumura
 * From WXIC.
 *
 * Revision 1.1.1.1  2008/01/07 02:11:49  umc
 * added proc_mode states for ProcessMonitor screen
 *
 * Revision 1.1.1.1  2006/06/30 06:44:06  okumura
 * this is first release for standard MACSv2for330.
 *
 *
 */
...
/**
 * MACS���䑤�̊e��X�e�[�^�X���`���܂��B<br>
 * ���̒�`�́Amacs_state.h���甲���o�������̂ł��B
 *
...
// �Ƃ肠����Macs2�̃w�b�_�[�ő�������̂������̂�Macs1����R�s�[��������
